...
let bad=JSON.parse(saved);bad.lastSession.schemaVersion=999;let rejected=boot(JSON.stringify(bad));assert(!rejected.main.innerHTML.includes('继续上次考试'),'未来断点schema未被安全拒绝');
